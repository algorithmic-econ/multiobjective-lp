...
from helpers.runners.model import Solver, RunnerConfig
...
if __name__ == "__main__":
    root_dir = "/Users/jasiek/Documents/Projects/pabulib"
    result_dir = "resources/experiment-results/greedy-phragmen-grouped/"
    ...
    output_path = Path(
        "../resources/input/experiment-config/greedy-phragmen-grouped.jsonc"
    )
